...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.device = torch.device('cuda:%d' % self.gpu_ids[0]) if self.gpu_ids and torch.cuda.is_available() else torch.device('cpu')
        ...
        netArc_checkpoint = torch.load(netArc_checkpoint, map_location=self.device)
